                            ...
                            @foreach ($cart as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <a class="btn btn-outline-warning" href="{{ $url }}">Giảm</a>
                                        ...
                                        @endphp
                                        <a class="btn btn-outline-success      " href="{{ $url }}">Tăng</a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <a class="btn btn-outline-danger" onclick="return confirm('Có chắn không?')"
                                            href="{{ $url }}">Xóa</a>
                                    </td>
                                </tr>
                            @endforeach
